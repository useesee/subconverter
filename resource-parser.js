...
let [link0, content0, subinfo] = [$resource.link, $resource.content, "upload=2375927198; download=12983696043; total=1099511627776; expire=1613059200"]
...
function flowcheck(cnt) {
    for (var i = 0; i < cnt.length; i++) {
        ...
        if (item.indexOf("剩余流量") != -1) {
            flow = nm
        } else if (item.indexOf("过期时间") != -1 || item.indexOf("到期时间") != -1) {
            exptime = nm
        }
    }
